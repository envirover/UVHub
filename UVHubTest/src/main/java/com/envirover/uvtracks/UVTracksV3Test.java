...
public class UVTracksV3Test {

    private final static Logger logger = LogManager.getLogger(UVTracksV3Test.class);

    UVTracksV3Client uvTracks = new UVTracksV3Client();
    ...
    public void testGetTracks() throws ClientProtocolException, URISyntaxException, IOException {
        logger.info("UVTracks TEST: GET /uvtracks/api/v3/tracks");
    ...
    public void testGetState() throws ClientProtocolException, URISyntaxException, IOException {
        logger.info("UVTracks TEST: GET /uvtracks/api/v3/state");
    ...
    public void testGetMissions() throws ClientProtocolException, URISyntaxException, IOException {
        logger.info("UVTracks TEST: GET /uvtracks/api/v3/missions");
    ...
    public void testGetParameters() throws ClientProtocolException, URISyntaxException, IOException {
        logger.info("UVTracks TEST: GET /uvtracks/api/v3/parameters");
